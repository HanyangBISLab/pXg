...
public class ParameterParser {
	...
	public static int parseParams (String[] args) {
		...
		Option optionPenaltyMutation = Option.builder("pm")
				.longOpt("penalty_mutation").argName("optional, float")
				.hasArg()
				.required(false)
